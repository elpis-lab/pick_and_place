...
class PickPlaceGUI:
    ...
    async def plan_execute_place(self, use_cartesian):
        ...
        try:
            ...
            if not place_result:
                return "Failed to get place location", None
            ...
            if trajectory:
                ...
                return "Place trajectory planned successfully", trajectory
            return "Failed to plan place trajectory", None
        except Exception as e:
            return f"Error planning place trajectory: {str(e)}", None
...
def create_gui():
    ...
    with gr.Blocks(title="Pick and Place Control Interface") as interface:
        ...
        #         <img src="file://images/elpis_lab.png" height="100px" width="100px" style="object-fit: contain;">
        #         <h1 style="margin: 0;">Robot Pick and Place Control System - ELPIS</h1>
        #     </div>
        # """)
        ...
        plan_place_cartesian_btn.click(
            ...
            outputs=[status_output, place_traj_status]
        )
...
if __name__ == "__main__":
    ...
    try:
        interface.launch(allowed_paths=["images/*"] ) # Removed share=true
    finally:
