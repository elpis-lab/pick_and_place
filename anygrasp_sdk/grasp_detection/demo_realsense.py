...
def setup_realsense(json_file):
    ...
    #    raise Exception("Device does not support advanced mode")
...
def demo():
    ...
    try:
        while True:
            ...
            # Run grasp detection
            try:
                gg, cloud = anygrasp.get_grasp(points, colors, lims=lims, apply_object_mask=True, dense_grasp=True, collision_detection=True) # Dense Grasp - False on default
                ...
                # Visualization of point cloud and gripper geometries
                vis.clear_geometries()

                # Apply transformation for visualization (flip z-axis)
                ...
                # Add the point cloud and grippers to the visualizer
