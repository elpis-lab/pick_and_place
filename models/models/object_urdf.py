"""Build URDF for objects. Script from https://github.com/harvard-microrobotics/object2urdf"""
...
class ObjectUrdfBuilder:
    def __init__(
        ...
        self.urdf_base = self._read_xml(
            os.path.join(object_folder, urdf_prototype)
        )
    ...
    def build_urdf(
        ...
        **kwargs
        ...
        if decompose_concave:
            ...
            urdf_out = self.update_urdf(
                rel, name, override=overrides, mass_center=mass_center
            )
