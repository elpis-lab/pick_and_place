...
class IntegratedGraspingSystem(Node):
    ...
    def visualize_cv2(self, color_image, langsam_result, anygrasp_result, fused_grasp):
    ...
    def run(self):
        ...
        while rclpy.ok():
            ...
            if self.visualize_cv2:
                self.visualize_cv2(color_image, langsam_result, anygrasp_result, fused_grasp)
